(()=>{var e={},t={};function n(a){var o=t[a];if(void 0!==o)return o.exports;var s=t[a]={exports:{}};return e[a](s,s.exports,n),s.exports}n.rv=function(){return"1.0.5"},n.ruid="bundler=rspack@1.0.5";let a=document.querySelector(".chatbot-container"),o=document.querySelector(".chatbot-toggle-btn"),s=document.querySelector(".chatbot-toggle-icon"),r=document.querySelector(".chatbot-body"),c=document.querySelector(".chatbot-footer");document.querySelector(".chatbot-close-btn img");let d=document.querySelector(".info-request"),i=document.querySelector(".name"),l=document.querySelector(".surname"),u=document.querySelector(".continue"),p=document.querySelector(".start"),m=document.querySelector(".chat-robot"),g=document.querySelector(".info-request"),v="",y="",h="";function L(){a.classList.toggle("show"),s.classList.toggle("resize")}function f(){document.getElementById("country-code-dropdown").classList.toggle("block")}async function b(e){let t=document.getElementById("userInput"),n=e||t.value.trim();if(""!==n){let e=document.querySelector(".suggestions");m.classList.add("hide"),g.classList.add("hide"),e.classList.add("hide");let a=document.createElement("div");a.classList.add("user-message-cont");let o=document.createElement("div");o.classList.add("user-message"),o.textContent=n,a.appendChild(o);let s=document.createElement("img");s.src="./Images/Frame.png",s.alt="user image",o.classList.add("message","user-message"),a.appendChild(s),r.appendChild(a);try{let e=await S(n,v,y,h);e&&setTimeout(()=>{let t=document.createElement("div");t.classList.add("bot-message-cont");let n=document.createElement("img");n.src="./Images/chat.png",n.alt="chatbot image",t.appendChild(n);let a=document.createElement("div");a.classList.add("bot-message"),a.textContent=e,t.appendChild(a),r.appendChild(t),r.scrollTop=r.scrollHeight},1e3)}catch(e){console.log("Error sending message:",e)}t.value=""}}async function S(e,t,n,a=""){let o="https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=AIzaSyCLvJCHHYlkycpevdWSsJ5sDJA3z6tovVw",s=`
    ...
    `;a&&(s+=`
Website: ${a}`);let r=`${s}
User Question: ${e}`;try{let e=await fetch(o,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{parts:[{text:r}]}]})});if(!e.ok)throw Error(`HTTP error! status: ${e.status}`);return(await e.json()).candidates[0].content.parts[0].text}catch(e){console.error("Error generating content:",e)}}o.addEventListener("click",L),u.addEventListener("click",()=>{if(i.reportValidity()){v=i.value,d.textContent="Por favor, coloque su contactos";let e=document.createElement("div");e.classList.add("phone-cont"),e.innerHTML=`
